...
class AdditionalDetail(models.Model):
    ...
    def __str__(self):
        return f"{self.ulid} - {self.details}"
...
class QADB(models.Model):
    ...
    other_ind_id = models.ManyToManyField(
        OtherIndividuals,
    ...
    additional_detail = models.ManyToManyField(
        AdditionalDetail,
        related_name="additional_detail_qadb",
        blank=True
    )
    ...
    actions_capa = models.ManyToManyField(
        ActionCAPA,
        related_name="actions_capa_qadb",
        blank=True
    )
